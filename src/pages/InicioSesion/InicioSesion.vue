<template>
    <form class="form_container" @submit.prevent="submitForm">
        <div class="logo_container" style="text-align: center; display: flex; justify-content: center;">
            <img src="@/assets/img/logo-colores.png" alt="Logo" width="60px" height="75px" style="padding-top: 3px;">
        </div>
        <div class="title_container">
            <p class="title">Inicio de Sesión</p>
            <span class="subtitle">ALUMINIO VIDRIOS SERVICIOS AFINES S.C.R.L.</span>
        </div>
        <br>
        <div class="input_container">
            <label class="input_label" for="user_field">Usuario</label>
            ...
            <input placeholder="usuario" type="text" class="input_field" v-model="email">
        </div>
        <div class="input_container">
            ...
            <input placeholder="contraseña" type="password" class="input_field" v-model="password">
        </div>
